                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="#">Nav
                                Item 2</a>
                                        ...
                                        <li class="nav-item mt-6 mb-3">
                                            <span class="nav-label">Site Settings</span> <span class="badge bg-light-info text-dark-info"></span></li>
                                        <li class="nav-item ">
                                        ...
                                        <li class="nav-item mt-6 mb-3">
                                            <span class="nav-label">Support</span> <span class="badge bg-light-info text-dark-info"></span></li>
                                        <li class="nav-item ">
                                            <a class="nav-link disabled" href="#!">
                                                <div class="d-flex align-items-center">
